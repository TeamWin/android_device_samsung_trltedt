...
TARGET_BOOTLOADER_BOARD_NAME := trltedt
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x02600000 --dt device/samsung/trltedt/dtb --tags_offset 0x02400000
...
#TARGET_PREBUILT_KERNEL := device/samsung/trltedt/kernAl
...
#BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/trltedt/custombootimg.mk
